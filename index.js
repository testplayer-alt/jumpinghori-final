...
const Scenes = {
  gametitle: "GameTitle",
  gamemain: "GameMain",
  gamemain_nomal: "GameMain-nomal",
  gamemain_heard: "GameMain-heard",
  gameover: "GameOver",
};
function reload() {
...
function update() {
  if(scene == Scenes.gametitle) {
    return;
  } else if(scene == Scenes.gamemain || scene == Scenes.gamemain_nomal || scene == Scenes.gamemain_heard){
    gamemain_bgm = true;
